---
title: "Data_visualization_principles_20191007_717_oh"
date: "`r Sys.Date()`"
output:
...
## 7.1 Encoding data using visual cues
...
## 7.4 Order categories by a meaningful value
...
## 7.6 Ease comparisons

### 7.6.1 Use common axes
...
### 7.6.2 Align plots vertically to see horizontal changes and horizontally to see vertical changes
...
### 7.6.3 Consider transformations
...
### 7.6.4 Visual cues to be compared should be adjacent
...
## 7.10 Avoid pseudo-three-dimensional plots
...
## 7.11 Avoid too many significant digits
...
## 7.13 Case study: impact of vaccines on battling infectious diseases
